...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        NGramMap map = new NGramMap(WORDS_FILE, TOTAL_COUNTS_FILE);
        hns.startUp();
        hns.register("history", new HistoryHandler(map));
        hns.register("historytext", new HistoryTextHandler(map));
        hns.register("hyponyms", new HyponymsHandler(LARGE_SYNSET_FILE, LARGE_HYPONYM_FILE,
                WORDS_FILE, TOTAL_COUNTS_FILE));
